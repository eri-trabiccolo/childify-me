...
Works also in themes live preview!
...
Child-theme's screenshot generated from the parent screenshot, with a ribbon dinamically added.
Child-theme's author dinamically generated from the user Name and Last Name, if set, otherwise fallbacks on the username.
...
* Thanks to @nikeo(http://www.themesandco.com) for spurring me, testing my plugin and for his valuable advices
