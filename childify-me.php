...
if ( ! class_exists( 'Childify_Me' ) ) :
	class Childify_Me {
		...
		private function cm_do_create_child_theme( $parent_stylesheet, $childname ) {
			...
			if ( ( $creds = request_filesystem_credentials( '', '', false, get_theme_root(), null ) ) === false ) {
				return;
			}
			...
			$parent_name            = $current_theme->Name ? $current_theme->Name : $parent_stylesheet;
			$child                  = $childname;
